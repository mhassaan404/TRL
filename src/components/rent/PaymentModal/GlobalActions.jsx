...
import { CCol, CFormLabel, CFormSelect, CFormInput, CFormTextarea, CFormCheck, CButton } from '@coreui/react';

const GlobalActionsSection = ({ rentForm, setRentForm, handleApplyGlobalDiscountAmount, handleApplyGlobalDiscountPercent, handleGlobalWaveChange }) => {
  return (
    <>
      <CCol md={3}>
