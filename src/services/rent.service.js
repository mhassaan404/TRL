...
export const rentService = {
  ...
  // Recommended: add these methods (used later in component)
  deleteHistoryRecord: async (id) => {
    return api.delete(`/Rent/History/${id}`)
  },

  reinstateTenant: async (id) => {
    return api.patch(`/Rent/History/Reinstate/${id}`, {})
  },
